...
const reviewSchema = new mongoose.Schema(
  {
    ...
    cours: {
      ...
      ref: 'Course', //Establishes references between reviews docs and Tour docs n it doesn't require to import the tourModel Class
...
reviewSchema.index({ cours: 1, user: 1 }, { unique: true });//will allowed each combination of tour n user to be unique n we'll not be able to create 2 reviews coming to the same user 
