...
export const signup = async (names, emails, contacts, passwords, passwordconfirms) =>{ // used to export the login function here
...
export const creatUsr = async (names, emails, contacts, passwords, passwordconfirms, types) =>{ // used to export the login function here
    //console.log(emails, passwords);
    try{ //axios is used communicate btw back-end n front-end 
        const res = await axios({ //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
            method: 'POST',
