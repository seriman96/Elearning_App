...
/* eslint-disable */
//used to disable eslint functionality for this file
//hide alert elt
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); //alert here comes from below div class
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); //select elt where we want to include html elt we just created above
...
exports.signup = exports.creatUsr = void 0;
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(names, emails, contacts, passwords, passwordconfirms) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'POST',
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Signed in successfully!'); //after one n half seconds load the front page(home page) .
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context.t0.response.data.message); //gives more detail to the error
...
var creatUsr = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(names, emails, contacts, passwords, passwordconfirms, types) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'User created successfully!'); //after one n half seconds load the front page(home page) .
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context2.t0.response.data.message); //gives more detail to the error
  ...
  return function creatUsr(_x6, _x7, _x8, _x9, _x10, _x11) {
    return _ref2.apply(this, arguments);
  };
}();

exports.creatUsr = creatUsr;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createCourse.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uploadc = exports.uploadCours = exports.updateCours = exports.upc = exports.topc = exports.top5 = exports.statisticrs = exports.searchc = exports.monthCours = exports.deleteCours = exports.delc = exports.createc = void 0;
...
var createc = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(names, durations, MaxGroupSize, difficulties, ratingsAVG, ratingsQu, prices, summarys, descriptions, imageCovers, image, startDate, coursCategorys, guide, discountPrices) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Course created successfully!'); //after one n half seconds load the front page(home page) .
  ...
  return function createc(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15) {
    return _ref.apply(this, arguments);
  };
}();
...
var topc = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ratingsAVG, prices, l, r) {
    var le, ge, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'GET',
              url: "http://127.0.0.1:8000/api/v1/tours?price[".concat(le, "]=").concat(prices, "&ratingsAverage[").concat(ge, "]=").concat(ratingsAVG)
            });
          ...
          case 7:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Course accessed successfully!');
              console.log(res.data.data.data); //console.log(res.data.data);
...

              {
                ...
                res.data.data.data.map(function (item) {
                  var markup = "<div class=\"card-container\" style=\"margin-bottom: 40px;\">\n                        <div class=\"card\">\n                            <div class=\"card__header\">\n                                <div class=\"card__picture\">\n                                    <div class=\"card__picture-overlay\">&nbsp;</div>\n                                    <img class=\"card__picture-img\" src=/img/tours/".concat(item.imageCover, " alt=").concat(item.name, "/>\n                                </div>\n                                <h2 class=\"heading-tertirary\"><span>").concat(item.name, "</span></h2>\n                            </div>\n                            <div class=\"card__details\">\n                                <h4 class=\"card__sub-heading\">").concat(item.difficulty, " ").concat(item.duration, "-day cours</h4>\n                                <p class=\"card__text\">").concat(item.summary, "</p>\n                                <div class=\"card__data\">\n                                    <svg class=\"card__icon\">\n                                        <use xlink:href=\"/img/icons.svg#icon-dollar-sign\"></use>\n                                    </svg>\n                                    <span>").concat(item.price, "</span>\n                                </div>\n                                <div class=\"card__data\">\n                                    <svg class=\"card__icon\">\n                                        <use xlink:href=\"/img/icons.svg#icon-calendar\"></use>\n                                    </svg>\n                                    <span>").concat(item.startDates[0].toLocaleString('en-us', {
                    month: 'long',
                    year: 'numeric'
                  }), "</span>\n                                </div>\n                                <div class=\"card__data\">\n                                    <svg class=\"card__icon\">\n                                        <use xlink:href=\"/img/icons.svg#icon-user\"></use>\n                                    </svg>\n                                    <span> rating (").concat(item.ratingsQuantity, ")</span>\n                                </div>\n                                <div class=\"card__data\">\n                                    <a class=\"edit btn--cours\" href=/cours/").concat(item._id, ">  \n                                        <svg class=\"card__icon\">\n                                            <use xlink:href=\"/img/icons.svg#icon-edit-2\"></use>\n                                        </svg>\n                                    </a>\n                            \n                                    <a class=\"edit btn--cours\" href=/cour/").concat(item._id, "> \n                                        <svg class=\"card__icon\">\n                                            <use xlink:href=\"/img/icons.svg#icon-delete\"></use>\n                                        </svg>\n                                    </a>\n                                    <a class=\"btn btn--green btn--small\" href=/tour/").concat(item.slug, ">Details</a>\n                                </div>\n                            </div>\n                        </div>\n                    </div>"); //select elt where we want to include html elt we just created above 

                  document.querySelector('.user-view__form-container').insertAdjacentHTML('beforebegin', markup); //console.log(item._id);
                  //cnt += 1;
                }); //console.log(cnt);
              } //after one n half seconds load the front page(home page) .

              window.setTimeout(function () {//location.assign('/api/v1/users/logout'); // /login //used in order to load another page n / here is to go to home page or load home page
  ...
  return function topc(_x16, _x17, _x18, _x19) {
    return _ref2.apply(this, arguments);
  };
}();
...
var searchc = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(slg) {
    var slgs, res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            //console.log(emails, passwords);
            slgs = slg.toLowerCase();
            _context3.prev = 1;
            _context3.next = 4;
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'GET',
              url: "http://127.0.0.1:8000/api/v1/tours?slug=".concat(slgs)
            });
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Course found successfully!'); //console.log(res.data.data.data);
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', _context3.t0.response.data.message); //gives more detail to the error
  ...
  return function searchc(_x20) {
    return _ref3.apply(this, arguments);
  };
}();

exports.searchc = searchc;

var upc = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(names) {
    var res;
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'GET',
              url: "http://127.0.0.1:8000/api/v1/tours?name=".concat(names)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Course found successfully!'); //console.log(res.data.data.data[0]._id); 
              //after one n half seconds load the front page(home page) .

              window.setTimeout(function () {
                //location.assign('/api/v1/users/logout'); // /login //used in order to load another page n / here is to go to home page or load home page
                location.assign("/cours/".concat(res.data.data.data[0]._id));
              }, 1500); //1500 is in millisecond n set the time to load home page here means 1500 ms after logging will load home page
            } //console.log(res)
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context4.t0.response.data.message); //gives more detail to the error
...
var uploadc = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(names) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Course found successfully!');
              console.log(res.data.data.data); //after one n half seconds load the front page(home page) .

              window.setTimeout(function () {
                //location.assign('/api/v1/users/logout'); // /login //used in order to load another page n / here is to go to home page or load home page
                location.assign("/crs/".concat(res.data.data.data[0]._id));
              }, 1500); //1500 is in millisecond n set the time to load home page here means 1500 ms after logging will load home page
            } //console.log(res)
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context5.t0.response.data.message); //gives more detail to the error
...
var delc = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(names) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Course found successfully!'); //after one n half seconds load the front page(home page) .

              window.setTimeout(function () {
                //location.assign('/api/v1/users/logout'); // /login //used in order to load another page n / here is to go to home page or load home page
                location.assign("/cour/".concat(res.data.data.data[0]._id));
              }, 1500); //1500 is in millisecond n set the time to load home page here means 1500 ms after logging will load home page
            } //console.log(res)
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context6.t0.response.data.message); //gives more detail to the error
...
var updateCours = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(coursId, data) {
    var res;
        ...
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/tours/".concat(coursId),
              data: data //headers,
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Course updated successfully!'); //after one n half seconds load the front page(home page) .
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context7.t0.response.data.message); //gives more detail to the error
  ...
  return function updateCours(_x24, _x25) {
...
var uploadCours = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(coursId, data) {
    var res;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 3:
            ...
            //console.log(res.data);
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Image uploaded successfully!'); //after one n half seconds load the front page(home page) .
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context8.t0.response.data.message); //gives more detail to the error
  ...
  return function uploadCours(_x26, _x27) {
    return _ref8.apply(this, arguments);
  };
}();

exports.uploadCours = uploadCours;

var deleteCours = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(coursId) {
        ...
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              (0, _alert.showAlert)('success', 'Course deleted successfully!');
              window.setTimeout(function () {
                location.assign("/cours"); //used in order to load another page n / here is to go to home page or load home page
              }, 1500);
            });
          ...
          case 5:
            ...
            (0, _alert.showAlert)('error', _context9.t0.response.data.message); //gives more detail to the error
  ...
  return function deleteCours(_x28) {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
            ...
            if (res.data.status === 'success') {
...

              {
                ...
                res.data.data.data.map(function (item) {
                  ...
                  document.querySelector('.user-view__content').insertAdjacentHTML('beforebegin', markup); //console.log(item.imageCover);
                  //cnt += 1;
                }); //console.log(cnt);
              }
            } //console.log(res)
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context10.t0.response.data.message); //gives more detail to the error
...
var monthCours = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(year) {
    var res;
        ...
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'GET',
              url: "http://127.0.0.1:8000/api/v1/tours/montly-plan/".concat(year)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Course found successfully!'); //console.log(res.data.data.plan); //.data.data

              {
                //var cnt = 0;
                res.data.data.plan.map(function (item) {
                  var markup = "<div class=\"card-container\" style=\"margin-top: 20px;\">\n                        <div class=\"card\" style=\"margin-bottom: 30px;\">\n                            <h2 class=\"heading-secondary ma-bt-lg\"> Month No. ".concat(item.month, "</h2>\n                           \n                            <div class=\"card__details\">\n                                <div class=\"card__data\">\n                                    <span> Total Nb of course<br/> ").concat(item.numTourStart, "</span> &nbsp;\n                                </div> \n                                <div class=\"card__data\">\n                                    <span> course<br/> ").concat(item.tours, " </span>\n                                </div>\n                            </div>\n                        </div>\n                    </div>"); //select elt where we want to include html elt we just created above 
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context11.t0.response.data.message); //gives more detail to the error
  ...
  return function monthCours(_x29) {
    return _ref11.apply(this, arguments);
  };
}();

exports.monthCours = monthCours;

var statisticrs = /*#__PURE__*/function () {
        ...
        switch (_context12.prev = _context12.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              {
                //var cnt = 0;
                res.data.data.stats.map(function (item) {
                  //console.log(item._id);
                  var markup = "<div class=\"card-container\" style=\"margin-top: 20px;\">\n                        <div class=\"card\" style=\"margin-bottom: 30px;\">\n                            <h2 class=\"heading-secondary ma-bt-lg\"> Difficulty ".concat(item._id, "</h2>\n                           \n                            <div class=\"card__details\">\n                                <div class=\"card__data\">\n                                    <span> Min Price ").concat(item.minPrice, "</span> &nbsp;\n                                    <span> Average Price ").concat(item.avgPrice, " </span>\n                                </div>\n                                <div class=\"card__data\">\n                                    <span> Average Rating ").concat(item.avgRating, " </span>\n                                </div>\n                                <div class=\"card__data\">\n                                    <span> Total Rating ").concat(item.numRatings, " </span>\n                                </div>\n                                <div class=\"card__data\">\n                                    <span> Total Nb Course ").concat(item.numTours, " </span>\n                                </div>\n                            </div>\n                        </div>\n                    </div>"); //select elt where we want to include html elt we just created above 
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context12.t0.response.data.message); //gives more detail to the error
  ...
  return function statisticrs() {
    return _ref12.apply(this, arguments);
  };
}();

exports.statisticrs = statisticrs;
...
exports.logout = exports.loginAfterSignIn = exports.login = void 0;
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(emails, passwords) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged in successfully!'); //after one n half seconds load the front page(home page) .
...
var loginAfterSignIn = /*#__PURE__*/function () {
  ...
  return function loginAfterSignIn(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
/*const login = async (emails, passwords) =>{ // used to export the login function here
    //console.log(emails, passwords);
    try{ //axios is used communicate btw back-end n front-end 
        ...
        console.log(err.response.data.message); //gives more detail to the error
    }  
}*/
...
exports.loginAfterSignIn = loginAfterSignIn;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"manageuser.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updtusers = exports.updateUsers = exports.searchuser = exports.deltusers = void 0;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'GET',
              url: "http://127.0.0.1:8000/api/v1/users?email=".concat(name)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              id = res.data.data.data[0]._id; //console.log(id);
              //after one n half seconds load the front page(home page) .
          ...
          case 7:
            ...
            if (resp.data.status === 'success') {
              (0, _alert.showAlert)('success', 'User found successfully!'); //console.log(res.data.data.data);
              //console.log(resp.data.data.data._id);

              id = resp.data.data.data._id; //id = res.data.data.data[0]._id;
              ...
              window.setTimeout(function () {
                //location.assign('/api/v1/users/logout'); // /login //used in order to load another page n / here is to go to home page or load home page
                location.assign("/reads/".concat(id));
              }, 1500); //1500 is in millisecond n set the time to load home page here means 1500 ms after logging will load home page
            } //console.log(res)
...
var updtusers = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            if (resp.data.status === 'success') {
              (0, _alert.showAlert)('success', 'User found successfully!'); //console.log(resp.data.data.data._id);

              ids = resp.data.data.data._id; //id = res.data.data.data[0]._id;
              ...
              window.setTimeout(function () {
                //location.assign('/api/v1/users/logout'); // /login //used in order to load another page n / here is to go to home page or load home page
                location.assign("/updat/".concat(ids));
              }, 1500); //1500 is in millisecond n set the time to load home page here means 1500 ms after logging will load home page
            } //console.log(res)
  ...
  return function updtusers(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updtusers = updtusers;

var deltusers = /*#__PURE__*/function () {
  ...
  return function deltusers(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

exports.deltusers = deltusers;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              //console.log(res.data.data);
              (0, _alert.showAlert)('success', "User data updated successfully!");
              window.setTimeout(function () {
                location.assign("/usr");
              }, 1500); //1500 is in millisecond n set the time to load home page here means 1500 ms after logging will load home page
            }
...
var stripe = Stripe('pk_test_51LHpTdSAQuXo2wkEaLtxBCCC2K1Of1pAkMV7Q7HfgQc5bKK285Xx2kx03ganzOw1AakyhCRCPE6rCQgqzEWdZR3C00SaB1JKPs'); //it's a public key
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"resetPass.js":[function(require,module,exports) {
"use strict";
...
var forgotpassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(emails) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            //console.log(res.data);
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Email sent successfully!'); //after one n half seconds load the front page(home page) .

              window.setTimeout(function () {
                location.assign("/resetPassword/".concat(res.data.data)); //`/api/v1/users/resetPassword/${res.data.data.passwordResetToken}`  //used in order to load another page n / here is to go to home page or load home page
              }, 1500); //1500 is in millisecond n set the time to load home page here means 1500 ms after logging will load home page
              //console.log(res.data.data);
            } //console.log(res)
...
var resetpassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tokenId, passwords, passwordConfirms) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/users/resetPassword/".concat(tokenId),
              data: {
                password: passwords,
                passwordConfirm: passwordConfirms
              }
          ...
          case 3:
            ...
            //console.log(res.data);
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Password resetted successfully!'); //after one n half seconds load the front page(home page) .
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"reviews.js":[function(require,module,exports) {
"use strict";
...
var updateReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(coursId, userId, reviews, ratings) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/reviews/".concat(coursId),
              data: {
                review: reviews,
                rating: ratings
              }
          ...
          case 3:
            ...
            //console.log(res.data);
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Reviews updated successfully!'); //after one n half seconds load the front page(home page) .

              window.setTimeout(function () {
                location.assign("/my-reviews/".concat(userId)); //used in order to load another page n / here is to go to home page or load home page
              }, 1500); //1500 is in millisecond n set the time to load home page here means 1500 ms after logging will load home page
              //console.log(res.data.data.passwordResetToken);
            } //console.log(res)
  ...
  return function updateReview(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(coursId, userId) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
...
var createReview = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(coursId, userId, reviews, ratings) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //it's called a client-facing code n axios method is throwning n error whenever we get n error back from our api input.
              method: 'POST',
              url: "http://127.0.0.1:8000/api/v1/tours/".concat(coursId, "/reviews"),
              data: {
                review: reviews,
                rating: ratings,
                cours: coursId,
          ...
          case 3:
            ...
            //console.log(res.data);
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Reviews posted successfully!'); //after one n half seconds load the front page(home page) .
  ...
  return function createReview(_x7, _x8, _x9, _x10) {
    return _ref3.apply(this, arguments);
  };
}();
...
var _createCourse = require("./createCourse");
...
var loginForm1 = document.querySelector('.form--login1');
var loginForm2 = document.querySelector('.form--login2');
var loginForm3 = document.querySelector('.form--login3');
var loginForm4 = document.getElementById('resetToken'); //
//manage user

var top5crs = document.querySelector('.form-user-queryTop');
var monthcrs = document.querySelector('.form-user-queryYear');
var statiscrs = document.querySelector('.form-user-queryStats');
var finduser = document.querySelector('.form-user-queryUsr');
var creatus = document.querySelector('.form--signupUsr');
var updusers = document.querySelector('.form-user-queryUpdUsr'); //courses

var createC = document.querySelector('.form-user-course'); //const createC = document.querySelector('form');

var readTopC = document.querySelector('.form-user-query');
var searchTopC = document.querySelector('.form-user-query1');
var updC = document.querySelector('.form-user-queryU');
var uplC = document.querySelector('.form-user-queryUp');
var delC = document.querySelector('.form-user-queryD');
var uC = document.querySelector('.form-user-courseu');
var upldcrs = document.querySelector('.form-user-courseI');
var delcrs = document.querySelector('.form-user-coursed');
var reviewForm = document.querySelector('.form--reviews');
var reviewForm1 = document.getElementById('user-id');
var reviewForm2 = document.getElementById('cours-id'); //it's reviews's id 

var reviewFormDel = document.querySelector('.form--reviews1');
/*const reviewFormDel1 = document.getElementById('user-id1'); 
const reviewFormDel2 = document.getElementById('cours-id1');*/

var reviewFormCre = document.querySelector('.form--reviews1');
var logOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userDataForm1 = document.querySelector('.form-user-data1');
var userDatadelt = document.querySelector('.form-user-queryUsr_del');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour'); //user managing

if (finduser) {
  finduser.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'Searching...';
    var price = document.getElementById('price').value; //console.log(price);

    (0, _manageuser.searchuser)(price);
  });
}
...
if (userDatadelt) {
  userDatadelt.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'Searching...';
    var price = document.getElementById('price').value; //console.log(price);

    (0, _manageuser.deltusers)(price);
  });
}
...
if (updusers) {
  updusers.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'Searching...';
    var price = document.getElementById('price').value; //console.log(price);

    (0, _manageuser.updtusers)(price);
  });
}
...
if (top5crs) {
  top5crs.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'finding...';
    (0, _createCourse.top5)();
  });
}
...
if (statiscrs) {
  statiscrs.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'finding...';
    (0, _createCourse.statisticrs)();
  });
}
...
if (monthcrs) {
  monthcrs.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'finding...';
    var year = document.getElementById('price').value;
    (0, _createCourse.monthCours)(year);
  });
}
...
if (creatus) {
  creatus.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd
    ...
    (0, _signup.creatUsr)(name, email, contact, password, passwordConfirm, type);
  });
}
...
if (readTopC) {
  readTopC.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'Searching...';
    var price = document.getElementById('price').value;
    var len = price.length;
    var le = price.substring(0, 2);
    var prc = price.substring(2, len + 1);
    var average = document.getElementById('average').value;
    var len1 = average.length;
    var ge = average.substring(0, 2);
    var avg = average.substring(2, len1 + 1); //console.log(avg*1);

    (0, _createCourse.topc)(avg * 1, prc * 1, le, ge);
  });
}
...
if (searchTopC) {
  searchTopC.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'Searching...';
    var price = document.getElementById('price').value;
    (0, _createCourse.searchc)(price);
  });
}
...
if (updC) {
  updC.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'Find...';
    var price = document.getElementById('price').value;
    (0, _createCourse.upc)(price);
  });
}
...
if (uplC) {
  uplC.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'Find...';
    var price = document.getElementById('price').value;
    (0, _createCourse.uploadc)(price);
  });
}
...
if (delC) {
  delC.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--green').textContent = 'Finding...';
    var price = document.getElementById('price').value;
    (0, _createCourse.delc)(price);
  });
}
...
if (delcrs) {
  delcrs.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd

    document.querySelector('.btn--reviewUpd1').textContent = 'Deleting...';
    var coursId = reviewForm2.value;
    (0, _createCourse.deleteCours)(coursId);
  });
}
...
if (upldcrs) {
  upldcrs.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd
    ...
    var imageCover = document.getElementById('photo1').value;
    var img = "".concat(imageCover); //console.log(imageCover1);

    var imgs = img.split('\\')[2];
    var images = document.getElementById('images').value; //console.log(images);
    //console.log();

    var imagess = [];

    for (var i = 0; i < images * 1 + 1; i++) {
      if (document.getElementById("photo_".concat(i))) {
        var im = "".concat(document.getElementById("photo_".concat(i)).value);
        var img1 = im.split('\\')[2]; //img1 = JSON.stringify(img1);
        //console.log(img);
    ...
    for(let i = 0; i <(images*1 + 1); i++) {
        if(document.getElementById(`photo_${i}`)){
            ...
            let selectedfile;
            selectedfile = img.files[0];
            sf.push(selectedfile);
            //sfn.push(selectedfile.name);
            //formData.append('images', selectedfile, selectedfile.name);
        }   
    }*/
    //console.log(sf);
    //console.log();
    //console.log(sf[0].name);
    ...
    formData.append('images[]', imagess); //formData.append('imageCover', selectfile, selectfile.name); 
    //formData.append('imageCover', fileFiled.files[0]);

    /*let ls = []
    for(let i = 0; i <(images*1 + 1); i++) {
        let df = sf[i].name;
        //console.log(df);
        formData.append('images[]', sf[i], df); 
        //ls.push(df)
    }*/

    /*console.log(`std: ${formData.getAll('images[]')}`);
    console.log(`std: ${formData.get('imageCover')}`);
    console.log([...formData]);*/

    /*for(var pr of formData.entries()){
        console.log(pr[0]+ ', ' + pr[1]);
    }*/

    (0, _createCourse.uploadCours)(coursId, formData);
  });
}

if (uC) {
  uC.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd
    ...
    var guide = document.getElementById('guides').value; //console.log(guide);

    var guides = [];

    for (var _i = 0; _i < guide * 1; _i++) {
      if (document.getElementById("guide".concat(_i)).checked) {
        guides.push(document.getElementById("guide".concat(_i)).value);
      }
    } //console.log(guides);
    //console.log();


    var starts = document.getElementById('start').value; //console.log(starts);

    var startDates = [];

    for (var _i2 = 0; _i2 < starts * 1; _i2++) {
      if (document.getElementById("startdate_".concat(_i2))) {
        if (document.getElementById("startdate_".concat(_i2)).value != '') {
          startDates.push(document.getElementById("startdate_".concat(_i2)).value);
        }
      }
    ...
    var course = document.getElementById('course').value; //const imageCover = document.getElementById('photo1').value;
    ...
    /*formData.append('imageCover', selectfile, selectfile.name); 
    let sf = [];
    //let sfn = [];
    for(let i = 0; i <(images*1 + 1); i++) {
        if(document.getElementById(`photo_${i}`)){*/
    ...
    for(var std in startDates){
    console.log(std);
    }*/
    //console.log(startDates.length);

    for (var i = 0; i < startDates.length; i++) {
      formData.append('startDates[]', startDates[i]); //console.log(`std: ${formData.getAll('startDates[]')}`);
    }

    formData.append('category', course);

    for (var i = 0; i < guides.length; i++) {
      formData.append('guides[]', guides[i]); //console.log(`std: ${formData.getAll('startDates[]')}`);
    }

    formData.append('priceDiscount', discountprice); //console.log(`std: ${formData.getAll('startDates[]')}`);
    //console.log(`std: ${formData.getAll('guides[]')}`);
    //console.log([...formData]);
    //createc(formData);

    (0, _createCourse.updateCours)(coursId, formData);
  });
}
...
if (createC) {
  createC.addEventListener('submit', function (e) {
    e.preventDefault(); //capturing email n passwd
    ...
    for (var i = 0; i < guide * 1; i++) {
      if (document.getElementById("guide".concat(i)).checked) {
        guides.push(document.getElementById("guide".concat(i)).value);
      }
    } //console.log(guides);
    //console.log();
    ...
    for (var _i3 = 0; _i3 < starts * 1; _i3++) {
      if (document.getElementById("startdate_".concat(_i3))) {
        if (document.getElementById("startdate_".concat(_i3)).value != '') {
          startDates.push(document.getElementById("startdate_".concat(_i3)).value);
        }
      }
    } //console.log(startDates);
    //console.log();
    ...
    var imgs = img.split('\\')[2]; //imgs = JSON.stringify(imgs);
    //console.log(imgs);
    ...
    for (var _i4 = 0; _i4 < images * 1 + 1; _i4++) {
      if (document.getElementById("photo_".concat(_i4))) {
        var im = "".concat(document.getElementById("photo_".concat(_i4)).value);
        var img1 = im.split('\\')[2]; //img1 = JSON.stringify(img1);
        //console.log(img);
    ...
    (0, _createCourse.createc)(name, duration, maxgroupsize, difficulty, average, quantity, price, summary, description, imgs, imagess, startDates, course, guides, discountprice);
  });
}
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordconfirm').value;
    (0, _signup.signup)(name, email, contact, password, passwordConfirm);
  });
}
...
if (loginForm1) {
  loginForm1.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    (0, _login.loginAfterSignIn)(email, password);
  });
}
...
if (loginForm2) {
  loginForm2.addEventListener('submit', function (e) {
    e.preventDefault();
    document.querySelector('.btn--green').textContent = 'Processing...'; //capturing email n passwd

    var email = document.getElementById('email').value;
    (0, _resetPass.forgotpassword)(email);
  });
}
...
if (loginForm3) {
  loginForm3.addEventListener('submit', function (e) {
    ...
    var tokenId = loginForm4.value; //console.log(`welcome dear ${tokenId}`);
    //capturing email n passwd

    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordconfirm').value;
    (0, _resetPass.resetpassword)(tokenId, password, passwordConfirm);
  });
}
...
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    e.preventDefault();
    document.querySelector('.btn--reviewUpd').textContent = 'Updating...';
    var userId = reviewForm1.value;
    var coursId = reviewForm2.value;
    var review = document.getElementById('review').value;
    var rating = document.getElementById('rating').value;
    (0, _reviews.updateReview)(coursId, userId, review, rating);
  });
}
...
if (reviewFormDel) {
  reviewFormDel.addEventListener('submit', function (e) {
    e.preventDefault();
    document.querySelector('.btn--reviewUpd1').textContent = 'Deleting...';
    var userId = reviewForm1.value;
    var coursId = reviewForm2.value;
    ...
    (0, _reviews.deleteReview)(coursId, userId); //userId, review, rating
  });
}
...
if (reviewFormCre) {
  reviewFormCre.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    var review = document.getElementById('review').value;
    var rating = document.getElementById('rating').value;
    (0, _reviews.createReview)(coursId, userId, review, rating);
  });
}
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    var form = new FormData(); //new form object
...
if (userDataForm1) {
  userDataForm1.addEventListener('submit', function (e) {
    e.preventDefault(); //will prevent the form for being submitted
    //capturing name n email
    //using form with upload file here image

    var user_id = document.getElementById('users-id').value;
    var form = new FormData(); //new form object
    ...
    (0, _manageuser.updateUsers)(form, user_id);
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              document.querySelector('.btn--save-password').textContent = 'Updating...'; //capturing passwd,...

              passwordCurrent = document.getElementById('password-current').value; //document.getElementById('') value is coming from template file attrib id
            ...
            case 7:
              ...
              document.querySelector('.btn--save-password').textContent = 'Save password'; //we donn't want passwd values to be showing from output(interface) after getting updated
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //if we've as above returned it should be taken as this line n e.target.dataset used to get tourId on the button
