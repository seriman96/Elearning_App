...
if(creatus){
    creatus.addEventListener('submit', e =>{
        ...
        //console.log(type);
        creatUsr(name, email, contact, password, passwordConfirm, type);
    });
};
...
if(createC){
    createC.addEventListener('submit', e =>{
        ...
        //console.log([...formData]);
        //createc(formData);
        createc(name, duration, maxgroupsize, difficulty, average, quantity, price, summary, description, imgs, imagess, startDates, course, guides, discountprice);
    });
};
