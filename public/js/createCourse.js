...
export const createc = async (names, durations, MaxGroupSize, difficulties, ratingsAVG, ratingsQu, prices, summarys, descriptions, imageCovers, image, startDate, coursCategorys, guide, discountPrices) =>{ 
    //data
...
export const updateCours = async (coursId, data) =>{ // used to export the login function here
    ...
    console.log(data.get('maxGroupSize'));
    console.log(data.get('difficulty'));
    console.log(data.get('ratingsAverage'));
    console.log(data.get('ratingsQuantity'));
