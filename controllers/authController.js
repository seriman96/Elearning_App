...
exports.login = catchAsync(async (req, res, next) => {
  ...
  exports.protect = catchAsync(async (req, res, next) => {
    ...
    //console.log(`tokens are following: ${token}`);
    ...
    //84306996fbb48f2b2bdaeb145c4f8ffdd8b6fbd9708ee81ec2acae9fffea7e9d
  ...
  exports.restrictTo = (...roles) => {
    return (req, res, next) => {
      ...
      if (!roles.includes(req.user.type)) { //will check if the current user is not included in the roles array so raise error
        return next(
  ...
  exports.forgotPassword = catchAsync(async (req, res, next) => {
   ...
   // console.log(user);
    ...
    //52c2613215bb169b92fbc7da68b193e7e4a69bce4460721e36a8edbb7b3c02e8
  ...
  exports.resetPassword = catchAsync(async (req, res, next) => {
    ...
    //console.log(`token checking: ${req.params.token}`);
