...
exports.setTourUserIds = (req, res, next) => { //we'll route this middw before createReview middw in order to combine them as it was defined in createReview middw below
    //Allow nested route
    if(!req.body.cours) req.body.cours = req.params.tourId; //will if we didn't specify the tour id in body then we want to define that as one coming from the url
