...
var fs=require("fs");
var gresults = require("./generateResultsController");
var ResultModel = require('./../models/resultModel');
var AnswersheetModel = require('./../models/answersSheetModel');
          ...
          if(err){
            ...
            MaxMarks(testid).then((Mmarks)=>{
              ...
              results.map((d,i)=>{
                ...
                worksheet.addRow({Name: d.userid.name, Email: d.userid.email, Contact : d.userid.contact,Organisation : d.userid.organisation,Type : d.testid.type,Title : d.testid.title,Score : d.score,Outof:M});
              })
