...
exports.updateMe = catchAsync(async (req, res, next) => {
  //console.log(req.file); //return detail of the uploaded file
...
exports.deleteMe = catchAsync(async (req, res, next) => {
    await User.findByIdAndUpdate(req.user.id, { status: false }); //we need protected route here to have id value for that we should set Authentication on postan to pass data from that middw to deleteMe midddw here
