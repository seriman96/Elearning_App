...
exports.aliasTopTours = (req, res, next) =>{
    ...
    req.query.fields = 'name,price,duration,slug,ratingsAverage,ratingsQuantity,summary,difficulty,guides,imageCover,startDates';  //in order to specify some fields, these r the permited fields here
    next();
};  
...
/*exports.getToursWithin = catchAsync(async (req, res, next) => {
    ...
    //so in this case, we need to add an index to startLocacation to be done on tourModel.js 
    res.status(200).json({
        status: 'success',
