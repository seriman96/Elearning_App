const mongoose = require('mongoose'); // used to establish connection btw app and mongodb through mongo driver
 


//catching uncaught exceptions it's all bug that has occurred on async code n that has not been handle anymore
//this part of code should be placed on top  bcs when error raise before that method it can not take an account n this method is not happening in a async way
